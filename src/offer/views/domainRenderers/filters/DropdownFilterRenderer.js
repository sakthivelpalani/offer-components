...
export default class DropdownFilterRenderer extends React.PureComponent {
    ...
    render() {
        ...
        const Option = (props) => {
            return (
                <div className="menuListItem" ref={props.innerRef} onClick={props.innerProps.onClick}>
        ...
        return <li>
            <div className="filterName"><span className={["iconWidth", "filterSprite", "bbicons"+[this.props.title.replace(/ /g, "")]].join(" ")}></span>{this.props.title}</div>
            <Select
